...
$q="select user_id from faculty where designation='Dean Faculty Affairs' ";
$r=pg_query($q);
$ros=pg_fetch_row($r);
if(!$ros) {
...
$q1 ="update faculty
set  designation='Dean Faculty Affairs'
...
<html lang="en">
<head>
  <title>Appoint Dean Faculty Affairs</title>
  <meta charset="utf-8">
...
<body>
<h1>  Appoint new Dean Faculty Affairs </h1>
